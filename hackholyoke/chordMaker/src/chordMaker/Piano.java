...
public class Piano implements ActionListener {
	...
	public Piano(){
        ...
        // Title label
        JLabel titleLabel = new JLabel("Chord Maker");
        ...
        // Create panel1
        JButton rhythmPanel1 = new JButton();
        rhythmPanel1.setName("Major");
		...
		rhythmPanel1.addActionListener(this);
		rhythmPanel1.setAlignmentX(Component.CENTER_ALIGNMENT);
        rhythmPanel1.add(Box.createRigidArea(new Dimension(10,0)));
        
        // Rhythm 1 label
        JLabel r1 = new JLabel("Major");
        ...
        // Create panel 2
        JButton rhythmPanel2 = new JButton();
        rhythmPanel2.setName("minor");
		...
		rhythmPanel2.addActionListener(this);
		rhythmPanel2.setAlignmentX(Component.CENTER_ALIGNMENT);
        rhythmPanel2.add(Box.createRigidArea(new Dimension(10,0)));
        
        // Rhythm 2 label
        JLabel r2 = new JLabel("minor");
	...
	public void playSong(){		
		...
		*/
        ...
        //        player.play(song+chords);
        if(isMajor == true) {
        		System.out.println(notesString);
        		player.play(notesString + " V1 Cmaj Gmaj Emin Cmaj");
        }

        if(isMinor == true) {
        		player.play(notesString + " V1 Cmin");
        }
